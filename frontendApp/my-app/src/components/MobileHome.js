...
const MobileHome = () => {
  ...
  const handleNavigateToProduct = () => {
    if (productSectionRef.current) {
      ...
      const offset = -335; // Adjust this value to set how much above or below the target element you want to scroll
  ...
  return (
    <div className="MobileHome">
      ...
      <div ref={productSectionRef} className="mobile-products-container">
